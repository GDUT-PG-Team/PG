...
from easy.fetcher.function import get_time
from easy.utils import get_real_answer
from easy.config import CONFIG, LOGGER
...
# jinjia2 config
env = Environment(
    loader=PackageLoader('easy.views.operate_blueprint', '../templates/operate'),
...
async def easy_add_book(request):
    """
    添加书架
    :param request:
    :return:
...
async def easy_add_bookmark(request):
    """
    添加书签
    :param request:
    :return:
...
async def easy_delete_book(request):
    """
    删除书架
    :param request:
    :return:
...
async def easy_delete_bookmark(request):
    """
    删除书签
    :param request:
    :return:
